...
export const metadata = {
  ...
  description: "Canva design prototype for JointHub Africa Mentor Hub.",
};
    ...
    <main className="min-h-screen bg-[#F4F7F7] text-[#0D1B2A]">
      <div className="border-b border-[#0D1B2A]/10 bg-[#0D1B2A] text-white">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-4 px-6 py-4">
          <div>
            ...
            <h1 className="text-lg font-semibold sm:text-xl">Mentor Hub design prototype</h1>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-8">
        <p className="max-w-3xl text-sm leading-relaxed text-[#0D1B2A]/70">
          This page embeds the shared Canva prototype so the team can review the design inside the
          product app. Use Open in Canva if the embed is blocked by browser permissions.
        </p>
